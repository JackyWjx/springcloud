...
import cn.wjx.springcloud.lb.LoadBalancer;
...
//    public static  final String PAYMENT_URL = "http://localhost:8001";
    ...
    public CommonResult<Payment> getPayment2(@PathVariable("id") Long id){
        ResponseEntity<CommonResult> forEntity = restTemplate.getForEntity(PAYMENT_URL + "/payment/queryById/" + id, CommonResult.class);
